...
.search-input {
    width: 100%; /* Make input fill the container's width */
  height: 40px; /* Make input fill the container's height */
  padding-right: 90px; /* Adjust this value to make room for the icon */
  font-size: 25px; /* Regular font size for the input text */
}
...
.search-icon {
  position: absolute;
  font-size: 22px; 
  right: 15px; /* Adjust this value to position the icon correctly */
  top: 50%;
  transform: translateY(-50%);
  pointer-events: action; /* Makes sure the icon doesn't interfere with input interaction */
}
  ...
  return <Nav>
    ...
    <ul className='navbar-lists'>
      ...
      <div className="search-container">
        <input className='search-input' placeholder='Search for Gold jewellery, Diamond...' />
